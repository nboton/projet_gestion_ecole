...
<html>
  <head>
    ...
    <title><?php echo $lang ['news_visitors']; ?></title>
...
<a href="add_article_visitors.php" class="btn btn-success new_lesson"><i class="glyphicon glyphicon-pencil"></i> <?php echo $lang ['new_topic']; ?></a>

<div class="clear"></div>

    <h1 class="h1_title"><?php echo $lang ['news_visitor']; ?></h1>
    <hr>
...
$count_sql = $connect->query ("SELECT * FROM topics_visitors");
...
if ($records_count != 0) {
      ...
      $stmt_topics = $connect->prepare("SELECT * FROM topics_visitors ORDER BY id DESC LIMIT $start, $end");
      $stmt_topics->execute();
       ...
       ?>
          <div class="single">
                ...
                <div class="single_header">
                  ...
                  <h2><a href="view_article_visitors.php?id=<?php echo $topic_id; ?>"><?php echo $topic_title; ?></a></h2>  
                ...
                <div class="row">
                    <div class="col-md-2">
                      <a href="view_article_visitors.php?id=<?php echo $topic_id; ?>">
                         <?php 
